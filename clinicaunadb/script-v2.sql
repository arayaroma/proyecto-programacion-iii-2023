 ...
 */
 ...
 ALTER TABLE CLINICAUNA."TBL_MEDICAL_APPOINTMENT" ADD CONSTRAINT "FK_TBL_MEDICAL_APPOINTMENT_TO_TBL_PATIENT_CARE" FOREIGN KEY ("ID") REFERENCES CLINICAUNA."TBL_PATIENT_CARE" ("ID") ENABLE;
 /**
 *
 * ALTER TRIGGERS
 */
