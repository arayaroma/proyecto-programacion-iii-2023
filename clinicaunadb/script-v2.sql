 ...
 */
 ...
 ALTER TABLE CLINICAUNA."TBL_PATIENT_CARE" ADD CONSTRAINT "FK_TBL_PATIENT_CARE_TO_TBL_MEDICAL_APPOINTMENT" FOREIGN KEY ("ID") REFERENCES CLINICAUNA."TBL_MEDICAL_APPOINTMENT" ("ID") ENABLE;
 /**
 *
 * ALTER TRIGGERS
 */
