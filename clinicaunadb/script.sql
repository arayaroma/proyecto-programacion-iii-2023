...
CREATE TABLE CLINICAUNA."TBL_AGENDA" (
    ...
    "PATIENT_CARE" NUMBER(38, 0) NOT NULL ENABLE,
...
-- TABLE TBL_SLOTS
CREATE TABLE CLINICAUNA."TBL_SLOTS" (
    "ID" NUMBER(38, 0) NOT NULL ENABLE,
    "AGENDA" NUMBER(38, 0) NOT NULL ENABLE,
    "MEDICAL_APPOINTMENT" NUMBER(38, 0) NOT NULL ENABLE,
    "DATE" DATE NOT NULL ENABLE,
    "TIMESLOT" VARCHAR2(5) NOT NULL ENABLE,
    "AVAILABLE" VARCHAR2(12) NOT NULL ENABLE,
    "VERSION" NUMBER(38, 0) NOT NULL ENABLE,
    CONSTRAINT "TBL_SLOTS_PK" PRIMARY KEY ("ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS" ENABLE,
    CONSTRAINT "TBL_SLOTS_AVAILABLE_CHECK" CHECK (AVAILABLE IN ('AVAILABLE', 'UNAVAILABLE')) ENABLE
) SEGMENT CREATION DEFERRED PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING TABLESPACE "USERS";
...
CREATE TABLE CLINICAUNA."TBL_REPORT" (
    ...
    CONSTRAINT "TBL_REPORT_FREQUENCY_CHECK" CHECK (FREQUENCY IN ('DAILY', 'WEEKLY', 'MONTHLY', 'ANNUALLY')) ENABLE
) SEGMENT CREATION DEFERRED PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING;

-- TABLE TBL_REPORT_VALUES
CREATE TABLE CLINICAUNA."TBL_REPORT_VALUES" (
    "ID" NUMBER(38, 0) NOT NULL ENABLE,
    "REPORT" NUMBER(38, 0) NOT NULL ENABLE,
    "NAME" VARCHAR2(32) NOT NULL ENABLE,
    "VALUE" VARCHAR2(256) NOT NULL ENABLE,
    "VERSION" NUMBER(38, 0) NOT NULL ENABLE,
    CONSTRAINT "TBL_REPORT_VALUES_PK" PRIMARY KEY ("ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS"
) SEGMENT CREATION DEFERRED PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING;
...
-- SEQ_SLOTS
CREATE SEQUENCE CLINICAUNA.SEQ_SLOTS INCREMENT BY 1 MINVALUE 0 MAXVALUE 9999999999999999999999999999 NOCYCLE NOCACHE NOORDER;
...
-- SEQ_REPORT_VALUES
CREATE SEQUENCE CLINICAUNA.SEQ_REPORT_VALUES INCREMENT BY 1 MINVALUE 0 MAXVALUE 9999999999999999999999999999 NOCYCLE NOCACHE NOORDER;
...
END;
 -- TGR_SLOTS
 CREATE OR REPLACE TRIGGER TGR_SLOTS BEFORE INSERT ON TBL_SLOTS FOR EACH ROW BEGIN IF :NEW.ID IS NULL OR :NEW.ID <= 0 THEN :NEW.ID := SEQ_SLOTS.NEXTVAL;
END IF;
END;
...
END;
 -- TGR_REPORT_VALUES
 CREATE OR REPLACE TRIGGER TGR_REPORT_VALUES BEFORE INSERT ON TBL_REPORT_VALUES FOR EACH ROW BEGIN IF :NEW.ID IS NULL OR :NEW.ID <= 0 THEN :NEW.ID := SEQ_REPORT_VALUES.NEXTVAL;
END IF;
END;
...
COMMENT ON COLUMN CLINICAUNA.TBL_SLOTS.AVAILABLE IS 'AVAILABLE(AVAILABLE, UNAVAILABLE)';
...
COMMENT ON COLUMN CLINICAUNA.TBL_REPORT.FREQUENCY IS 'FREQUENCY(DAILY, WEEKLY, MONTHLY, ANNUALLY)';
 /**
 *
 * ALTER TABLES
 */
 ...
 -- FK TBL_SLOTS -> TBL_AGENDA
 ALTER TABLE CLINICAUNA."TBL_SLOTS" ADD CONSTRAINT "FK_TBL_SLOTS_TO_TBL_AGENDA" FOREIGN KEY ("AGENDA") REFERENCES CLINICAUNA."TBL_AGENDA" ("ID") ENABLE;
 ...
 -- FK TBL_REPORT_VALUES -> TBL_REPORT
 ALTER TABLE CLINICAUNA."TBL_REPORT_VALUES" ADD CONSTRAINT "FK_TBL_REPORT_VALUES_TO_TBL_REPORT" FOREIGN KEY ("REPORT") REFERENCES CLINICAUNA."TBL_REPORT" ("ID") ENABLE;
 ...
 -- FK TBL_AGENDA -> TBL_PATIENT_CARE
 ALTER TABLE CLINICAUNA."TBL_AGENDA" ADD CONSTRAINT "FK_TBL_AGENDA_TO_TBL_PATIENT_CARE" FOREIGN KEY ("PATIENT_CARE") REFERENCES CLINICAUNA."TBL_PATIENT_CARE" ("ID") ENABLE;
 -- FK TBL_SLOTS -> TBL_MEDICAL_APPOINTMENT
 ALTER TABLE CLINICAUNA."TBL_SLOTS" ADD CONSTRAINT "FK_TBL_SLOTS_TO_TBL_MEDICAL_APPOINTMENT" FOREIGN KEY ("MEDICAL_APPOINTMENT") REFERENCES CLINICAUNA."TBL_MEDICAL_APPOINTMENT" ("ID") ENABLE;
 /**
 *
 * ALTER TRIGGERS
 */
...
ALTER TRIGGER CLINICAUNA."TGR_SLOTS" ENABLE;
...
ALTER TRIGGER CLINICAUNA."TGR_REPORT_VALUES" ENABLE;
