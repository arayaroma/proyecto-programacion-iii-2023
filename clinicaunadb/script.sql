...
CREATE TABLE CLINICAUNA."TBL_APPOINTMENT" (
    "ID" NUMBER(38, 0) NOT NULL ENABLE,
...
CREATE TABLE CLINICAUNA."TBL_MEDICAL_APPOINTMENT" (
    ...
    "DATE" DATE NOT NULL ENABLE,
    "VERSION" NUMBER(38, 0) NOT NULL ENABLE,
    CONSTRAINT "TBL_MEDICAL_APPOINTMENT_PK" PRIMARY KEY ("ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS" ENABLE
) SEGMENT CREATION DEFERRED PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING TABLESPACE "USERS";
...
CREATE TABLE CLINICAUNA."TBL_MEDICAL_APPOINTMENT_DETAIL" (
    ...
    "OBSEVATIONS" VARCHAR2(256),
    "PHYSICALEXAM" VARCHAR2(256),
    "TRERATMENT" VARCHAR2(256),
    "VERSION" NUMBER(38, 0) NOT NULL ENABLE,
...
-- TABLE TBL_WEIGHT_HISTORY
CREATE TABLE CLINICAUNA."TBL_WEIGHT_HISTORY" (
    "ID" NUMBER(38, 0) NOT NULL ENABLE,
    "PATIENT" NUMBER(38, 0) NOT NULL ENABLE,
    "DATE" DATE NOT NULL ENABLE,
    "ACTUALWEIGHT" VARCHAR2(8) NOT NULL ENABLE,
    "GOALWEIGHT" VARCHAR2(8) NOT NULL ENABLE,
    "VERSION" NUMBER(38, 0) NOT NULL ENABLE,
    CONSTRAINT "TBL_WEIGHT_HISTORY_PK" PRIMARY KEY ("ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS" ENABLE,
    CONSTRAINT "TBL_WEIGHT_HISTORY_DATE_UK" UNIQUE ("DATE") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS" ENABLE,
    CONSTRAINT "TBL_WEIGHT_HISTORY_ACTUALWEIGHT_CHECK" CHECK (ACTUALWEIGHT > 0) ENABLE
) SEGMENT CREATION DEFERRED PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING TABLESPACE "USERS";
...
-- SEQ_APPOINTMENT
CREATE SEQUENCE CLINICAUNA.SEQ_APPOINTMENT INCREMENT BY 1 MINVALUE 0 MAXVALUE 9999999999999999999999999999 NOCYCLE NOCACHE NOORDER;
...
-- SEQ_WEIGHT_HISTORY
CREATE SEQUENCE CLINICAUNA.SEQ_WEIGHT_HISTORY INCREMENT BY 1 MINVALUE 0 MAXVALUE 9999999999999999999999999999 NOCYCLE NOCACHE NOORDER;
...
END;
 -- TGR_APPOINTMENT
 CREATE OR REPLACE TRIGGER TGR_APPOINTMENT BEFORE INSERT ON TBL_APPOINTMENT FOR EACH ROW BEGIN IF :NEW.ID IS NULL OR :NEW.ID <= 0 THEN :NEW.ID := SEQ_APPOINTMENT.NEXTVAL;
END IF;
END;
 -- TGR_PATIENT
...
END;
 -- TGR_WEIGHT_HISTORY
 CREATE OR REPLACE TRIGGER TGR_WEIGHT_HISTORY BEFORE INSERT ON TBL_WEIGHT_HISTORY FOR EACH ROW BEGIN IF :NEW.ID IS NULL OR :NEW.ID <= 0 THEN :NEW.ID := SEQ_WEIGHT_HISTORY.NEXTVAL;
END IF;
END;
 /**
 *
...
COMMENT ON COLUMN CLINICAUNA.TBL_APPOINTMENT.STATE IS 'STATE(SCHEDULED, ATTENDED, CANCELLED, ABSENT)';
COMMENT ON COLUMN CLINICAUNA.TBL_PATIENT.GENDER IS 'GENDER(MALE, FEMALE)';
COMMENT ON COLUMN CLINICAUNA.TBL_WEIGHT_HISTORY.ACTUALWEIGHT IS 'ACTUALWEIGHT(KG)';
COMMENT ON COLUMN CLINICAUNA.TBL_WEIGHT_HISTORY.GOALWEIGHT IS 'GOALWEIGHT(KG)';
 /**
 *
 * ALTER TABLES
 */
 ...
 ALTER TABLE CLINICAUNA."TBL_DOCTOR" ADD CONSTRAINT "FK_TBL_DOCTOR_TO_TBL_USER" FOREIGN KEY ("IDCARD") REFERENCES CLINICAUNA."TBL_USER" ("ID") ENABLE;
 ...
 -- FK TBL_APPOINTMENT -> TBL_AGENDA
 ALTER TABLE CLINICAUNA."TBL_APPOINTMENT" ADD CONSTRAINT "FK_TBL_APPOINTMENT_TO_TBL_AGENDA" FOREIGN KEY ("AGENDA") REFERENCES CLINICAUNA."TBL_AGENDA" ("ID") ENABLE;
 -- FK TBL_APPOINTMENT -> TBL_PATIENT
 ALTER TABLE CLINICAUNA."TBL_APPOINTMENT" ADD CONSTRAINT "FK_TBL_APPOINTMENT_TO_TBL_PATIENT" FOREIGN KEY ("PATIENT") REFERENCES CLINICAUNA."TBL_PATIENT" ("ID") ENABLE;
 -- FK TBL_APPOINTMENT -> TBL_USER
 ALTER TABLE CLINICAUNA."TBL_APPOINTMENT" ADD CONSTRAINT "FK_TBL_APPOINTMENT_TO_TBL_USER" FOREIGN KEY ("SCHEDULEBY") REFERENCES CLINICAUNA."TBL_USER" ("ID") ENABLE;
 ...
 -- FK TBL_MEDICAL_APPOINTMENT -> TBL_DOCTOR
 ALTER TABLE CLINICAUNA."TBL_MEDICAL_APPOINTMENT" ADD CONSTRAINT "FK_TBL_MEDICAL_APPOINTMENT_TO_TBL_DOCTOR" FOREIGN KEY ("DOCTOR") REFERENCES CLINICAUNA."TBL_DOCTOR" ("ID") ENABLE;
 -- FK TBL_MEDICAL_APPOINTMENT -> TBL_PATIENT
 ALTER TABLE CLINICAUNA."TBL_MEDICAL_APPOINTMENT" ADD CONSTRAINT "FK_TBL_MEDICAL_APPOINTMENT_TO_TBL_PATIENT" FOREIGN KEY ("PATIENT") REFERENCES CLINICAUNA."TBL_PATIENT" ("ID") ENABLE;
 -- FK TBL_MEDICAL_APPOINTMENT_DETAIL -> TBL_MEDICAL_APPOINTMENT
 ALTER TABLE CLINICAUNA."TBL_MEDICAL_APPOINTMENT_DETAIL" ADD CONSTRAINT "FK_TBL_MEDICAL_APPOINTMENT_DETAIL_TO_TBL_MEDICAL_APPOINTMENT" FOREIGN KEY ("MEDICALAPPOINTMENT") REFERENCES CLINICAUNA."TBL_MEDICAL_APPOINTMENT" ("ID") ENABLE;
 -- FK TBL_MEDICAL_EXAM -> TBL_PATIENT
 ALTER TABLE CLINICAUNA."TBL_MEDICAL_EXAM" ADD CONSTRAINT "FK_TBL_MEDICAL_EXAM_TO_TBL_PATIENT" FOREIGN KEY ("PATIENT") REFERENCES CLINICAUNA."TBL_PATIENT" ("ID") ENABLE;
 -- FK TBL_WEIGHT_HISTORY -> TBL_PATIENT
 ALTER TABLE CLINICAUNA."TBL_WEIGHT_HISTORY" ADD CONSTRAINT "FK_TBL_WEIGHT_HISTORY_TO_TBL_PATIENT" FOREIGN KEY ("PATIENT") REFERENCES CLINICAUNA."TBL_PATIENT" ("ID") ENABLE;
 /**
 *
 * ALTER TRIGGERS
 */
...
ALTER TRIGGER CLINICAUNA."TGR_APPOINTMENT" ENABLE;
...
ALTER TRIGGER CLINICAUNA."TGR_WEIGHT_HISTORY" ENABLE;