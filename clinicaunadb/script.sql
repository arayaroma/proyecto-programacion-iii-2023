...
CREATE TABLE CLINICAUNA."TBL_AGENDA" (
    ...
    "PATIENTCARE" NUMBER(38, 0) NOT NULL ENABLE,
 ...
 */
 ...
 ALTER TABLE CLINICAUNA."TBL_AGENDA" ADD CONSTRAINT "FK_TBL_AGENDA_TO_TBL_PATIENT_CARE" FOREIGN KEY ("PATIENTCARE") REFERENCES CLINICAUNA."TBL_PATIENT_CARE" ("ID") ENABLE;
 -- FK TBL_SLOTS -> TBL_MEDICAL_APPOINTMENT
 ALTER TABLE CLINICAUNA."TBL_SLOTS" ADD CONSTRAINT "FK_TBL_SLOTS_TO_TBL_MEDICAL_APPOINTMENT" FOREIGN KEY ("MEDICALAPPOINTMENT") REFERENCES CLINICAUNA."TBL_MEDICAL_APPOINTMENT" ("ID") ENABLE;
 /**
 *
 * ALTER TRIGGERS
 */
